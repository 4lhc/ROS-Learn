...
#  date   : Tue 08 Oct 2019 08:49:38 UTC
#  ver    :
#
#  Action server node to make ARdrone make a square in the air

# int32 goal    #number of sides
# ---
# int32 result  #current side
# ---
# int32 feedback #total time taken in seconds to complete the square
